...
public class ArcUtils {
     ...
     */
    public static void drawArc(PointF e1, PointF e2, float radius, Canvas canvas, Paint paint,
                               Paint textPaint, long stroke, String value) {
        ...
        canvas.drawText(value, (float) (mX + deltax),
