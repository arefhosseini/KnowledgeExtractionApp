...
import ir.fearefull.knowledgeextractionapp.ui.relation.MyCardsViewModel
...
class ViewModelProviderFactory @Inject constructor(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(MyCardsViewModel::class.java) -> MyCardsViewModel(dataManager, schedulerProvider) as T
            modelClass.isAssignableFrom(RelationViewModel::class.java) -> RelationViewModel(dataManager, schedulerProvider) as T
